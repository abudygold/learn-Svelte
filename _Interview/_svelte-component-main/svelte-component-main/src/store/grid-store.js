...
const listData = writable([
	...
	},
	{
		...
		title: 'Lyse lejligheder i New York-stil beliggende i hjertet af det pulserende Islands Brygge!',
		monthly_rent: 26900,
...
const grids = {
	subscribe: listData.subscribe,
	getDataById: (id, listData) => {
		const gridIndex = listData.findIndex(t => t.id === id);

		return { ...listData[gridIndex] };
	},
};
